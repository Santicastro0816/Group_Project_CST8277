...
public class TestACMECollegeSystem {
    ...
    @Test
    @Order(19)
    public void test19_get_all_course_registrations_with_admin_role() {
        Response response = webTarget
            .register(adminAuth)
    ...
    @Test
    @Order(20)
    public void test20_create_course_registration_with_admin_role() {
    ...
    @Test
    @Order(21)
    public void test21_assign_professor_to_course_registration() {
    ...
    @Test
    @Order(22)
    public void test22_assign_grade_to_course_registration() {
        if (createdRegistrationStudentId == null || createdRegistrationCourseId == null) {
            logger.warn("Skipping test - no registration created");
            return;
        }
    ...
    @Test
    @Order(23)
    public void test23_get_course_registration_by_id() {
        Response response = webTarget
            .register(adminAuth)
            .path(COURSE_REGISTRATION_RESOURCE_NAME)
            .path("1")
    ...
    @Test
    @Order(24)
    public void test24_get_all_letter_grades() {
        Response response = webTarget
            .register(adminAuth)
            .path(COURSE_REGISTRATION_RESOURCE_NAME)
            .path("lettergrade")
    ...
    @Test
    @Order(25)
    public void test25_unauthorized_access_without_auth() {
        Response response = webTarget
            .path(STUDENT_RESOURCE_NAME)
            .request(MediaType.APPLICATION_JSON)
            .get();
    ...
    @Test
    @Order(26)
    public void test26_user_role_cannot_access_all_students() {
        Response response = webTarget
            .register(userAuth)
            .path(STUDENT_RESOURCE_NAME)
            .request(MediaType.APPLICATION_JSON)
    ...
    @Test
    @Order(27)
    public void test27_wrong_media_type_request() {
        Response response = webTarget
            .register(adminAuth)
            .path(STUDENT_RESOURCE_NAME)
    ...
    @Test
    @Order(28)
    public void test28_get_course_registration_not_found() {
        Response response = webTarget
            .register(adminAuth)
            .path(COURSE_REGISTRATION_RESOURCE_NAME)
            .path("99999")
    ...
    @Test
    @Order(29)
    public void test29_invalid_json_payload() {
        Response response = webTarget
            .register(adminAuth)
            .path(STUDENT_RESOURCE_NAME)
            .request(MediaType.APPLICATION_JSON)
    ...
    @Test
    @Order(30)
    public void test30_user_role_can_access_own_student() {
    ...
    @Test
    @Order(31)
    public void test31_delete_course_registration() {
        if (createdRegistrationStudentId == null || createdRegistrationCourseId == null) {
            logger.warn("Skipping test - no registration created");
            return;
        }
    ...
    @Test
    @Order(32)
    public void test32_delete_student_club() {
        if (createdClubId == null) {
            logger.warn("Skipping test - no club created");
            return;
        }
    ...
    @Test
    @Order(33)
    public void test33_delete_professor() {
        if (createdProfessorId == null) {
            logger.warn("Skipping test - no professor created");
            return;
        }
    ...
    @Test
    @Order(34)
    public void test34_delete_course() {
        if (createdCourseId == null) {
            logger.warn("Skipping test - no course created");
            return;
        }
    ...
    @Test
    @Order(35)
    public void test35_delete_student() {
        if (createdStudentId == null) {
            logger.warn("Skipping test - no student created");
            return;
        }
